...
#include "maxent.h"
#include "common.h"
#include "au_edu_uq_eresearch_biolark_ta_genia_GeniaJNI.h"
...
JNIEXPORT jstring JNICALL Java_au_edu_uq_eresearch_biolark_ta_genia_GeniaJNI_initialize (JNIEnv *env, jobject obj, jstring s) {
...
JNIEXPORT jstring JNICALL Java_au_edu_uq_eresearch_biolark_ta_genia_GeniaJNI_tagSentence(JNIEnv *env, jobject obj, jstring sentence) {
