...
public class PTTokenPermutationInitializer extends FirstTokenPermLookupInitializerImpl
{
    ...
    {
        final String textMetaFields = this.ivProps.getProperty(TEXT_MFS_PRP_KEY);
        ...
        final int maxPermutationLevel = Integer.parseInt(this.ivProps.getProperty(MAX_P_LEVEL_PRP_KEY));
